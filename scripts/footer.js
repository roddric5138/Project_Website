...
footer[1] = '	<ul>';
footer[2] = '			<li style="padding-top:0; margin-top:0; "><a href="forms.html"#"> FORMS</a></li>';
footer[3] = '			<br>';
footer[4] = '			<li><a href="alumni.html"> ALUMNI</a></li>';
footer[5] = '			<br>';
footer[6] = '			<li><a href="sitemap.html"> SITEMAP</a></li>';
footer[7] = '	</ul>';
footer[8] = '</div>';
